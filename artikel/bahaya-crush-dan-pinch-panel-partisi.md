---
article_id: PAR-17-03
title: "Crush, Pinch, dan Stored Energy saat Panel Bergerak"
slug: "bahaya-crush-dan-pinch-panel-partisi"
description: "Explain hands and feet, panel swing, unexpected movement, slope, seals, locks, unstable parking, isolation and stop-work triggers"
status: outline
publication_date: "2026-06-19"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PAR-17
primary_intent: "Control movement and repair hazards"
reader_community: "Partisi.co.id"
reader_address: "Teman Partisi.co.id"
final_route: "/artikel/bahaya-crush-dan-pinch-panel-partisi.html"
...
# Crush, Pinch, dan Stored Energy saat Panel Bergerak

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Crush, Pinch, dan Stored Energy saat Panel Bergerak”
- **Reader and situation:** Operator or technician near moving panels
- **Reader outcome:** Explain hands and feet, panel swing, unexpected movement, slope, seals, locks, unstable parking, isolation and stop-work triggers
- **Primary intent:** Control movement and repair hazards
...
- **Scope boundary:** Does not teach repair; PAR-16-02 owns fault triage
- **Final public route:** `/artikel/bahaya-crush-dan-pinch-panel-partisi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Crush, Pinch, dan Stored Energy saat Panel Bergerak**.
...
- `PAR-17-02` → `/artikel/data-lifting-track-dan-panel-partisi.html` — Lifting Track dan Panel: Data yang Diperlukan sebelum Mengangkat
- `PAR-17-04` → `/artikel/keselamatan-partisi-otomatis.html` — Mesin, Listrik, dan Kontrol pada Partisi Otomatis
- `PAR-17-05` → `/artikel/kerja-di-ketinggian-untuk-track-partisi.html` — Kerja di Ketinggian dan Akses Maintenance Track
...
- **Tie back to this article:** Keep the explanation specific to “Crush, Pinch, dan Stored Energy saat Panel Bergerak”.

...
- **Writer task:** Expand this file into one complete article answering: “Mesin, Listrik, dan Kontrol pada Partisi Otomatis”
- **Reader and situation:** Owner considering powered operation
- **Reader outcome:** Cover guarding, sensing, emergency stop, isolation, manual override, failure state, competence, inspection and records
- **Primary intent:** Identify automation hazards and controls
...
- **Scope boundary:** Does not design controls or electrical protection; qualified disciplines own them
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mesin, Listrik, dan Kontrol pada Partisi Otomatis**.
...
- **Tie back to this article:** Keep the explanation specific to “Mesin, Listrik, dan Kontrol pada Partisi Otomatis”.

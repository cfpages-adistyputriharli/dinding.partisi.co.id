...
- **Writer task:** Expand this file into one complete article answering: “Menghitung Kuantitas Panel, Track, dan Area Finish dari Opening”
- **Reader and situation:** Estimator using surveyed dimensions
- **Reader outcome:** Show assumptions for opening, panelization, stacking, track path, junctions, finish faces and uncertainty
- **Primary intent:** Build an auditable preliminary quantity
...
- **Scope boundary:** Does not create fabrication dimensions; PAR-10-05 owns shop drawings
- **Final public route:** `/artikel/menghitung-kuantitas-partisi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Menghitung Kuantitas Panel, Track, dan Area Finish dari Opening**.
...
- **Tie back to this article:** Keep the explanation specific to “Menghitung Kuantitas Panel, Track, dan Area Finish dari Opening”.

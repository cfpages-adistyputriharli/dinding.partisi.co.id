...
title: "Rockwool, Glasswool, dan Core Panel: Jangan Menyamakan Isi dengan Hasil Akustik"
slug: "core-panel-dan-bukti-akustik"
description: "Explain material role, containment, thickness, density evidence, panel coupling and whole-system limits"
status: outline
publication_date: "2025-09-03"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PAR-05
primary_intent: "Interpret infill claims correctly"
reader_community: "Partisi.co.id"
reader_address: "Teman Partisi.co.id"
final_route: "/artikel/core-panel-dan-bukti-akustik.html"
...
# Rockwool, Glasswool, dan Core Panel: Jangan Menyamakan Isi dengan Hasil Akustik

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Rockwool, Glasswool, dan Core Panel: Jangan Menyamakan Isi dengan Hasil Akustik”
- **Reader and situation:** Buyer seeing insulation type and density in a quote
- **Reader outcome:** Explain material role, containment, thickness, density evidence, panel coupling and whole-system limits
- **Primary intent:** Interpret infill claims correctly
...
- **Scope boundary:** Does not assign a dB result; PAR-06-02 owns test evidence
- **Final public route:** `/artikel/core-panel-dan-bukti-akustik.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Rockwool, Glasswool, dan Core Panel: Jangan Menyamakan Isi dengan Hasil Akustik**.
...
- `PAR-05-01` → `/artikel/memilih-material-panel-partisi.html` — Memilih Material Panel Partisi dari Fungsi, Bukan Nama Bahan
- `PAR-05-02` → `/artikel/plywood-versus-mdf-panel-partisi.html` — Plywood atau MDF untuk Panel Partisi: Apa yang Perlu Dibandingkan?
- `PAR-05-04` → `/artikel/memilih-finish-partisi-bergerak.html` — HPL, Fabric, Wallpaper, dan Finish Lain untuk Partisi Bergerak
- `PAR-05-05` → `/artikel/kelembapan-dan-panel-partisi.html` — Kelembapan, Kondensasi, dan Perubahan Dimensi pada Panel Partisi
...
- **Tie back to this article:** Keep the explanation specific to “Rockwool, Glasswool, dan Core Panel: Jangan Menyamakan Isi dengan Hasil Akustik”.
